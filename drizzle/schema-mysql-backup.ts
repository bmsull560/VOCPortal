...
export const users = pgTable("users", {
  ...
  // VOS-specific fields
  vosRole: vosRoleEnum("vosRole"),
  maturityLevel: integer("maturityLevel").default(0).notNull(), // 0-5

  // Onboarding tracking
  onboardingCompleted: boolean("onboardingCompleted").default(false).notNull(),
  onboardingStep: integer("onboardingStep").default(0).notNull(),
  learningPathPreference: learningPathPreferenceEnum("learningPathPreference"),
...
export const userLearningProgress = pgTable("userLearningProgress", {
  ...
  currentPillarNumber: integer("currentPillarNumber").default(1).notNull(),
  ...
  totalLessonsCompleted: integer("totalLessonsCompleted").default(0).notNull(),
